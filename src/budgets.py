...
def calculation_d() -> list[str]:
    ...
    lines += [
        ...
        "",
        "  Two things this table is not. It is not a compliance determination: whether",
        "  a report was in fact filed with the Commission or with Cal OES is not public,",
        "  and CeSIA has asked the Commission publicly to say whether and when a report",
        "  under Article 55(1)(c) was made. And 'BREACHED' here means the interval to",
        "  PUBLIC DISCLOSURE exceeded the deadline, which is the only date the record",
        "  supplies; a non-public report to a regulator could have been timely.",
        "",
